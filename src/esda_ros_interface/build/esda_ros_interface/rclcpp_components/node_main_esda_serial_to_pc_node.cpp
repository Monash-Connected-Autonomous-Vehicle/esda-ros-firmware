...
#define NODE_MAIN_LOGGER_NAME "esda_serial_to_pc_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "esda_serial_to_pc";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<esda_serial_to_pc::ROS2ToSerialBridge>";
